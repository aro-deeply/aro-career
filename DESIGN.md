...
- 작성일: 2026-04-29
- 대상 레포: [aro-deeply/aro-landing](https://github.com/aro-deeply/aro-landing)
...
| # | 항목 | 결정 |
|---|---|---|
| 1 | 통합 방식 | **같은 사이트의 다른 경로** (`aro-landing.vercel.app/diagnosis`). 한 레포·한 Vercel 프로젝트로 통합. |
...
3. 입력값:
   ...
   - **Domain**: 본인 Vercel 운영 URL (예: `aro-landing.vercel.app`)
