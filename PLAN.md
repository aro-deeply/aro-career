...
- [ ] **Step 3: Cloudflare Turnstile 사이트 등록**
  ...
  - Domain: `aro-career.vercel.app` + `localhost`
  - Widget Mode: Managed
...
운영 URL(예: `https://aro-career.vercel.app/diagnosis`)에서 한 사이클 끝까지 돌려본다.

- [ ] **Step 1: 랜딩페이지 → 진단 페이지 이동 확인**

`https://aro-career.vercel.app/` 접속 → CTA 4곳 중 아무거나 클릭 → `/diagnosis`로 이동되는지 확인.
